...
datatableHighlight.ATTRS = {
    highlightRows: {
        value: false,
        setter: '_setHighlightableRows',
        validator: Y.Lang.isBoolean
    },
    highlightCols: {
        value: false,
        setter: '_setHighlightableCols',
        validator: Y.Lang.isBoolean
    },
    highlightCells: {
        value: false,
        setter: '_setHighlightableCells',
        validator: Y.Lang.isBoolean
    }
};
...
datatableHighlight.prototype = {
    ...
    _setHighlightableRows: function (highlightingRows) {
        if (highlightingRows) {
    ...
    _setHighlightableCols: function (highlightingCols) {
        if (highlightingCols) {
    ...
    _setHighlightableCells: function (highlightingCells) {
